...
describe('test acceptOfferRenderingsAndCreateMoneyTransfert', () => {
  ...
  it('Should do the procedure without error', async () => {
    ...
    transactionOperationsMock.acceptOfferRenderingsAndCreateMoneyTransfertTransaction.mockResolvedValueOnce(
      true
    )
    ...
    expect(
      transactionOperationsMock.acceptOfferRenderingsAndCreateMoneyTransfertTransaction
